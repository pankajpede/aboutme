...
export const SphereImageGrid: React.FC<SphereImageGridProps> = ({
  ...
  const renderSpotlightModal = () => {
    ...
    return (
      ...
      >
        <div
          className="bg-surface border border-border rounded-xl max-w-md w-full overflow-hidden shadow-2xl"
        ...
        >
          ...
          {(selectedImage.title || selectedImage.description) && (
            <div className="p-6">
              {selectedImage.title && (
                <h3 className="text-xl font-bold font-display text-ink mb-2">{selectedImage.title}</h3>
              )}
  ...
  if (!isMounted) {
    return (
      <div
        className="bg-surface rounded-lg animate-pulse flex items-center justify-center border border-border"
        style={{ width: containerSize, height: containerSize }}
      >
        <div className="text-muted text-xs">Loading 3D Sphere...</div>
      </div>
    );
  }
  ...
  if (!images.length) {
    return (
      <div
        className="bg-surface rounded-lg border-2 border-dashed border-border flex items-center justify-center"
        style={{ width: containerSize, height: containerSize }}
      >
